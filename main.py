...
def Plot_field_profile(component,component_name,
    ...
    fig, ax = plt.subplots(1,3,figsize=(10, 5),dpi=dpi)
    plt.subplots_adjust(left=0.05, right=0.95, wspace =0.3, hspace =0.3)   #调整子图间距
    ...
    for idx in range(3):
        im = ax[idx].imshow(component_list[idx], cmap='inferno')
...
class Parameter_sweeper():
    ...
    # Save supermodes results using coupled mode theory
...
if __name__ == '__main__':
    ...
    # foldername1 = "Python/Mode Profiles/"+\
    #                 "InnerRingXYZ_Lx_8um_bendr_1000um_800x400cells_beta_ang_21_wavls"+"/1550"
    # foldername2 = "Python/Mode Profiles/"+\
    #                 "OuterRingDesigned_800x400cells_21_wavls"+"/1550"
    ...
    foldername1 = "Python/Mode Profiles/"+\
                    "InnerRingXYZ_Lx_8um_bendr_1000um_20x10um_800x400cells_beta_ang_21_wavls"
    foldername2 = "Python/Mode Profiles/"+\
